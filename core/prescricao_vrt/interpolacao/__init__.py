...
try:
    ...
    print(f"[WARN] Erro ao importar configuracao: {e}")
...
try:
    ...
    print(f"[WARN] Erro ao importar contratos: {e}")
...
try:
    ...
    print(f"[WARN] Erro ao importar motor: {e}")
    # Criar classe vazia
    class Interpolador:
        pass
    InterpoladorSolo = Interpolador
...
try:
    ...
    print(f"[WARN] Erro ao importar validacao: {e}")
