...
class PrescricaoZona:
    ...
    nitrogenio: ResultadoNutriente = field(default_factory=None)
    fosforo: ResultadoNutriente = field(default_factory=None)
    potassio: ResultadoNutriente = field(default_factory=None)
    calcio: ResultadoNutriente = field(default_factory=None)
    magnesio: ResultadoNutriente = field(default_factory=None)
    enxofre: ResultadoNutriente = field(default_factory=None)
    boro: ResultadoNutriente = field(default_factory=None)
    cobre: ResultadoNutriente = field(default_factory=None)
    ferro: ResultadoNutriente = field(default_factory=None)
    manganes: ResultadoNutriente = field(default_factory=None)
    zinco: ResultadoNutriente = field(default_factory=None)
